...
export const useDialogueSelector = () => {
  ...
  return { setSelectedDialogue1, setSelectedDialogue2, setSelectedDialogue3, setSelectedDialogue4, setSelectedDialogue5, selectedDialogue1, selectedDialogue2, selectRandomDialogue1, selectRandomDialogue2, selectedDialogue3, selectedDialogue4, selectedDialogue5};
};
